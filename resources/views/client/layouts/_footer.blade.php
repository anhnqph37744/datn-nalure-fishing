<footer class="footer-wrapper space-top bg-smoke">
                    ...
                    <div class="widget footer-widget">
                        ...
                        <div class="sidebar-gallery">
                            <div class="gallery-thumb">
                                <img src="{{asset('client/assets/img/widget/gal-1-1.jpg')}}" alt="Gallery Image" class="w-100">
                                <a href="{{asset('client/assets/img/widget/gal-1-1.jpg')}}" class="popup-image gal-btn">
                                    <i class="far fa-search-plus"></i></a>
                            </div>
                            <div class="gallery-thumb">
                                <img src="{{asset('client/assets/img/widget/gal-1-2.jpg')}}" alt="Gallery Image" class="w-100">
                                <a href="{{asset('client/assets/img/widget/gal-1-2.jpg')}}" class="popup-image gal-btn">
                                    <i class="far fa-search-plus"></i></a>
                            </div>
                            <div class="gallery-thumb">
                                <img src="{{asset('client/assets/img/widget/gal-1-3.jpg')}}" alt="Gallery Image" class="w-100">
                                <a href="{{asset('client/assets/img/widget/gal-1-3.jpg')}}" class="popup-image gal-btn">
                                    <i class="far fa-search-plus"></i></a>
                            </div>
                            <div class="gallery-thumb">
                                <img src="{{asset('client/assets/img/widget/gal-1-4.jpg')}}" alt="Gallery Image" class="w-100">
                                <a href="{{asset('client/assets/img/widget/gal-1-4.jpg')}}" class="popup-image gal-btn">
                                    <i class="far fa-search-plus"></i></a>
                            </div>
                            <div class="gallery-thumb">
                                <img src="{{asset('client/assets/img/widget/gal-1-5.jpg')}}" alt="Gallery Image" class="w-100">
                                <a href="{{asset('client/assets/img/widget/gal-1-5.jpg')}}" class="popup-image gal-btn">
                                    <i class="far fa-search-plus"></i></a>
                            </div>
                            <div class="gallery-thumb">
                                <img src="{{asset('client/assets/img/widget/gal-1-6.jpg')}}" alt="Gallery Image" class="w-100">
                                <a href="{{asset('client/assets/img/widget/gal-1-6.jpg')}}" class="popup-image gal-btn">
                                    <i class="far fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>
