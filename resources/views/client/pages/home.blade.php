        ...
        data-xs-center-mode="true" data-arrows="true" data-dots="false">
            <div class="col-auto">
                <div class="service-style1">
                    <div class="service-img"><img src="{{asset('client/assets/img/service/sr-1-1.png')}}" alt="service thumbnail"></div>
                    <div class="service-icon"><img src="{{asset('client/assets/img/icon/sr-1-1.svg')}}" alt="icon"></div>
            ...
            <div class="col-auto">
                <div class="service-style1">
                    <div class="service-img"><img src="{{asset('client/assets/img/service/sr-1-2.png')}}" alt="service thumbnail"></div>
                    <div class="service-icon"><img src="{{asset('client/assets/img/icon/sr-1-2.svg')}}" alt="icon"></div>
            ...
            <div class="col-auto">
                <div class="service-style1">
                    <div class="service-img"><img src="{{asset('client/assets/img/service/sr-1-3.png')}}" alt="service thumbnail"></div>
                    <div class="service-icon"><img src="{{asset('client/assets/img/icon/sr-1-3.svg')}}" alt="icon"></div>
            ...
            <div class="col-auto">
                <div class="service-style1">
                    <div class="service-img"><img src="{{asset('client/assets/img/service/sr-1-4.png')}}" alt="service thumbnail"></div>
                    <div class="service-icon"><img src="{{asset('client/assets/img/icon/sr-1-4.svg')}}" alt="icon"></div>
            ...
            <div class="col-auto">
                <div class="service-style1">
                    <div class="service-img"><img src="{{asset('client/assets/img/service/sr-1-1.png')}}" alt="service thumbnail"></div>
                    <div class="service-icon"><img src="{{asset('client/assets/img/icon/sr-1-5.svg')}}" alt="icon"></div>
                    <h3 class="service-title h6"><a class="text-inherit" href="service-details.html">Free Fishing</a></h3>
                    <p class="service-text">Curabitur is a aliquet quam id dui posre blandgit ivamus magna.</p>
                    <div class="link-btn">
                        <a href="service-details.html">Read More <i class="far fa-arrow-right"></i></a>
            ...
            <div class="col-auto">
                <div class="service-style1">
                    <div class="service-img"><img src="{{asset('client/assets/img/service/sr-1-2.png')}}" alt="service thumbnail"></div>
                    <div class="service-icon"><img src="{{asset('client/assets/img/icon/sr-1-6.svg')}}" alt="icon"></div>
                    <h3 class="service-title h6"><a class="text-inherit" href="service-details.html">Float Fishing</a></h3>
                    <p class="service-text">Curabitur is a aliquet quam id dui posre blandgit ivamus magna.</p>
                    <div class="link-btn">
                        <a href="service-details.html">Read More <i class="far fa-arrow-right"></i></a>
            ...
            <div class="col-auto">
                <div class="service-style1">
                    <div class="service-img"><img src="{{asset('client/assets/img/service/sr-1-3.png')}}" alt="service thumbnail"></div>
                    <div class="service-icon"><img src="{{asset('client/assets/img/icon/sr-1-7.svg')}}" alt="icon"></div>
                    <h3 class="service-title h6"><a class="text-inherit" href="service-details.html">Solo & Team Fishing</a></h3>
                    <p class="service-text">Curabitur is a aliquet quam id dui posre blandgit ivamus magna.</p>
                    <div class="link-btn">
                        <a href="service-details.html">Read More <i class="far fa-arrow-right"></i></a>
    ...
    <div class="container">
        <div class="row gx-40">
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="img_box1">
                    <div class="img_1 mega-hover"><img src="{{asset('client/assets/img/explore/exp-1-2.png')}}" alt="about"></div>
                    <div class="img_2 mega-hover"><img src="{{asset('client/assets/img/explore/exp-1-1.png')}}" alt="about"></div>
                    <div class="exp_box1">
...
<section class="space overflow-hidden position-relative counter" data-bg-src="{{asset('client/assets/img/bg/counter-bg.png')}}">
            ...
            <div class="row gx-0 align-items-center">
                ...
                <div class="col-lg-auto position-relative">
                    <div class="testi_avater1">
                        <div id="testis_4_2">
                                <div class="avater"><img src="{{asset('client/assets/img/testimonial/testi-1-1.png')}}" alt="author">
                                </div>
                                <div class="avater"><img src="{{asset('client/assets/img/testimonial/testi-1-2.png')}}" alt="author">
                                </div>
                                <div class="avater"><img src="{{asset('client/assets/img/testimonial/testi-1-3.png')}}" alt="author">
                                </div>
                                <div class="avater"><img src="{{asset('client/assets/img/testimonial/testi-1-4.png')}}" alt="author">
                                </div>
                                <div class="avater"><img src="{{asset('client/assets/img/testimonial/testi-1-5.png')}}" alt="author">
                                </div>
                                <div class="avater"><img src="{{asset('client/assets/img/testimonial/testi-1-6.png')}}" alt="author">
                                </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="testi-img1" id="testis_4_3">
                        <div><img src="{{asset('client/assets/img/testimonial/testi-img-2-1.jpg')}}" alt="testimonial"></div>
                        <div><img src="{{asset('client/assets/img/testimonial/testi-img-2-2.jpg')}}" alt="testimonial"></div>
                        <div><img src="{{asset('client/assets/img/testimonial/testi-img-2-3.jpg')}}" alt="testimonial"></div>
                        <div><img src="{{asset('client/assets/img/testimonial/testi-img-2-4.jpg')}}" alt="testimonial"></div>
                        <div><img src="{{asset('client/assets/img/testimonial/testi-img-2-1.jpg')}}" alt="testimonial"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="service_style3">
            <div class="service_inner">
                ...
                <div class="service_content">
                    ...
                    <a href="service-details.html" class="vs-btn style3">View More<i class="fal fa-arrow-right"></i></a>
                </div>
            </div>
            <div class="service_inner">
                <a href="service-details.html" class="service_img"
...
<section class="bg-title space">
    <div class="container space-bottom">
        ...
        <div class="row vs-carousel mb-4" data-arrows="true" data-wow-delay="0.4s"  data-lg-slide-show="3" data-slide-show="4"
        data-md-slide-show="2" data-center-mode="true" data-xl-center-mode="true"
        data-ml-center-mode="true" data-lg-center-mode="true" data-md-center-mode="true"
        data-sm-center-mode="true">
        <div class="col-auto">
            <div class="product-style1">
                <div class="product-img">
                    ...
                    <div class="clipped">
                        <img src="{[asset('client/assets/img/product/p-1-1.png')]}" alt="shop">
                    </div>
                ...
                <div class="product-body">
                    ...
                    <h3 class="product-title"><a class="text-inherit" href="shop-details.html">Spoon lure tackle Baits</a></h3>
            ...
            <div class="col-auto">
                <div class="product-style1">
                    <div class="product-img">
                        <div class="shape-style1"></div>
                        <div class="clipped">
                            <img src="{{asset('client/assets/img/product/p-1-2.png')}}" alt="shop">
                        </div>
                        <div class="actions-style1">
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a class="text-inherit" href="shop-details.html">Crossfire Spinning Reel</a></h3>
            ...
            <div class="col-auto">
                <div class="product-style1">
                    <div class="product-img">
                        <div class="shape-style1"></div>
                        <div class="clipped">
                            <img src="{{asset('client/assets/img/product/p-1-3.png')}}" alt="shop">
                        </div>
                        <div class="actions-style1">
                            <a href="shop-details.html" class="icon-btn2">
                                <i class="far fa-heart"></i>
            ...
            <div class="col-auto">
                <div class="product-style1">
                    <div class="product-img">
                        <div class="shape-style1"></div>
                        <div class="clipped">
                            <img src="{{asset('client/assets/img/product/p-1-4.png')}}" alt="shop">
                        </div>
                        <div class="actions-style1">
                            <a href="shop-details.html" class="icon-btn2">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a class="text-inherit" href="shop-details.html">Fishing Reels Globeride</a></h3>
                        <span class="product-price"><span class="currency">$</span>200</span>
                    </div>
                </div>
            </div>
            <div class="col-auto">
                <div class="product-style1">
                    <div class="product-img">
                        <div class="shape-style1"></div>
                        <div class="clipped">
                            <img src="{{asset('client/assets/img/product/p-1-5.png')}}" alt="shop">
                        </div>
                        <div class="actions-style1">
                            <a href="shop-details.html" class="icon-btn2">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a class="text-inherit" href="shop-details.html">Fishing tackle Bag</a></h3>
            ...
            <div class="col-auto">
                <div class="product-style1">
                    <div class="product-img">
                        <div class="shape-style1"></div>
                        <div class="clipped">
                            <img src="{{asset('client/assets/img/product/p-1-6.png')}}" alt="shop">
                        </div>
                        <div class="actions-style1">
                            <a href="shop-details.html" class="icon-btn2">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a class="text-inherit" href="shop-details.html">Recreational fishing Rod</a></h3>
            ...
            <div class="col-auto">
                <div class="product-style1">
                    <div class="product-img">
                        <div class="shape-style1"></div>
                        <div class="clipped">
                            <img src="{{asset('client/assets/img/product/p-1-7.png')}}" alt="shop">
                        </div>
                        <div class="actions-style1">
                            <a href="shop-details.html" class="icon-btn2">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a class="text-inherit" href="shop-details.html">Fishing Reels Spin</a></h3>
            ...
            <div class="col-auto">
                <div class="product-style1">
                    <div class="product-img">
                        <div class="shape-style1"></div>
                        <div class="clipped">
                            <img src="{{asset('client/assets/img/product/p-1-8.png')}}" alt="shop">
                        </div>
                        <div class="actions-style1">
                            <a href="shop-details.html" class="icon-btn2">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a class="text-inherit" href="shop-details.html">Fishing Baits & Lures</a></h3>
            ...
            <div class="col-auto">
                <div class="product-style1">
                    <div class="product-img">
                        <div class="shape-style1"></div>
                        <div class="clipped">
                            <img src="{{asset('client/assets/img/product/p-1-9.png')}}" alt="shop">
                        </div>
                        <div class="actions-style1">
                            <a href="shop-details.html" class="icon-btn2">
                                <i class="far fa-heart"></i>
                    ...
                    <div class="product-body">
                        ...
                        <h3 class="product-title"><a class="text-inherit" href="shop-details.html">Fishing Hand Net</a></h3>
...
<div>
    <div class="vs-container1">
        <div class="brands">
            <div class="row gx-5 vs-carousel z-index-common" data-arrows="false" data-wow-delay="0.4s" data-slide-show="5"
            data-lg-slide-show="5" data-md-slide-show="3" data-xs-slide-show="1" data-center-mode="true" data-xl-center-mode="true"
            data-ml-center-mode="true" data-lg-center-mode="true" data-md-center-mode="true" data-sm-center-mode="true"
    ...
    <div class="container">
        ...
        data-sm-center-mode="true">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="vs-blog blog-style1">
                    <div class="blog-img">
                        <img class="w-100" src="{{asset('client/assets/img/blog/blog-1-5.jpg')}}" alt="Blog Img">
                        <div class="blog-meta2">
                            <span class="day">08</span>
                            <span class="month">January</span>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="vs-blog blog-style1">
                    <div class="blog-img">
                        <img class="w-100" src="{{asset('client/assets/img/blog/blog-1-6.jpg')}}" alt="Blog Img">
                        <div class="blog-meta2">
                            <span class="day">09</span>
                            <span class="month">January</span>
                        </div>
