...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            var doughnutData = {
                labels: @json($chart1Labels ?? []),
                datasets: [{
                    data: @json($chart1Data ?? []),
                    backgroundColor: ["#a3e1d4", "#dedede", "#9CC3DA", "#F7B924", "#76C1FA"],
                }, ],
            };
            ...
            var doughnutData = {
                ...
                datasets: [{
                    ...
                    backgroundColor: ["#a3e1d4", "#dedede", "#9CC3DA", "#F8AC59", "#ed5565"],
                }, ],
            };
