...
Route::prefix('dashboard')->group(function () {
    ...
    // banner
    Route::get('/', [BannerController::class, 'index'])->name('index'); // Hiển thị danh sách banner
    Route::get('/create', [BannerController::class, 'create'])->name('create'); // Form thêm banner
    Route::post('/store', [BannerController::class, 'store'])->name('store'); // Lưu banner vào DB
    //role
