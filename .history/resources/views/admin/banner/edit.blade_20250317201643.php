                                ...
                                <div id="imagePreviewContainer" style="display: flex; gap: 10px; margin-top: 10px; flex-wrap: wrap;">
                                    @if (!empty($oldImages) && is_array($oldImages))
                                        @foreach ($oldImages as $oldImage)
                                            <div>
                                                <img src="{{ asset('storage/' . $oldImage) }}" class="img-thumbnail" style="width: 100px; height: auto;">
                                            </div>
                                        @endforeach
                                    @else
                                        <p>Chưa có ảnh</p>
